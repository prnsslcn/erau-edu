...
export const alt = "ERAU Pathway Program — From Dream to Flight Deck.";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

// OG에 쓰이는 모든 문자(서브셋 로드용)
const TEXT =
  "ERAU Pathway Program From Dream to Flight Deck. PRE-ADMISSION ONLINE www.eraukorea.com";

// Google Fonts에서 해당 weight의 ttf 서브셋만 가져오기
async function loadOutfit(weight: number): Promise<ArrayBuffer> {
  const url = `https://fonts.googleapis.com/css2?family=Outfit:wght@${weight}&text=${encodeURIComponent(
    TEXT,
  )}`;
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <svg width="760" height="760" viewBox="0 0 257.24 307" fill="#bfdbfe">
            <path d={PLANE_PATH} />
          </svg>
        </div>
        ...
        >
          <div style={{ fontSize: 150, fontWeight: 800, color: "#1e293b", lineHeight: 1 }}>
            ERAU
          </div>
        </div>
        <div style={{ fontSize: 76, fontWeight: 300, color: "#475569", lineHeight: 1.1 }}>
          Pathway Program
        </div>
    ...
    ),
    {
      ...size,
      fonts: [
        { name: "Outfit", data: w300, weight: 300, style: "normal" },
